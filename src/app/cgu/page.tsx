...
export const metadata = { title: "CGU — Shiftips" };
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="prose prose-sm max-w-none text-ink-muted leading-relaxed space-y-6">
          <section>
            ...
            <p>Shiftips est une application gratuite destinée aux professionnels de la restauration pour suivre leurs heures de service et leurs pourboires. L&apos;utilisation de l&apos;application est soumise aux présentes CGU.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">Utilisation</h2>
            <p>L&apos;application est réservée à un usage personnel. Vous vous engagez à ne pas utiliser Shiftips à des fins illégales ou contraires aux présentes conditions.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">Responsabilité</h2>
            <p>Les calculs fournis par Shiftips (heures supplémentaires, repos théoriques) sont indicatifs. Ils ne constituent pas un avis juridique ou comptable. Pour toute question sur vos droits salariaux, référez-vous à votre convention collective et à votre employeur.</p>
          </section>
          <section>
