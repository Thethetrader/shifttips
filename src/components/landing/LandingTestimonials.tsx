...
const testimonials = [
  {
    ...
    initial: "CR",
    color: "bg-emerald",
    quote: "Je savais pas que mes pourboires pesaient autant. Avec Shyftips j'ai vu que sur le mois j'avais touché 920 € de tips. Avant je les dépensais sans même les compter. Maintenant je les mets de côté.",
  },
  {
    name: "Théo M.",
